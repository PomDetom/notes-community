...
import com.pomdetom.notes.question.mapper.QuestionMapper;
...
import com.pomdetom.notes.common.model.dto.question.*;
import com.pomdetom.notes.common.model.entity.Category;
import com.pomdetom.notes.common.model.entity.Note;
import com.pomdetom.notes.common.model.entity.Question;
import com.pomdetom.notes.common.model.vo.question.CreateQuestionVO;
import com.pomdetom.notes.common.model.vo.question.QuestionNoteVO;
import com.pomdetom.notes.common.model.vo.question.QuestionUserVO;
import com.pomdetom.notes.common.model.vo.question.QuestionVO;
...
import com.pomdetom.notes.common.utils.MarkdownAST;
...
public class QuestionServiceImpl implements QuestionService {
    ...
    public ApiResponse<CreateQuestionVO> createQuestion(CreateQuestionBody createQuestionBody) {
        ...
        // 校验分类 Id 是否合法
        Category category = categoryService.findById(createQuestionBody.getCategoryId());
        if (category == null) {
    ...
    public ApiResponse<List<QuestionUserVO>> userGetQuestions(QuestionQueryParam queryParams) {
        ...
        if (UserContext.isLogin() && UserContext.getUserId() != null) {
            userFinishedQuestionIds = noteService.filterFinishedQuestionIdsByUser(UserContext.getUserId(), questionIds);
        } else {
    ...
    public ApiResponse<QuestionNoteVO> userGetQuestion(Integer questionId) {
        ...
        // 如果是登录状态，则查询出当前用户笔记
        if (UserContext.isLogin() && UserContext.getUserId() != null) {
            Note note = noteService.findByAuthorIdAndQuestionId(UserContext.getUserId(), questionId);
            if (note != null) {
    ...
    @Override
    public List<Question> findByIdBatch(List<Integer> questionIds) {
        return questionMapper.findByIdBatch(questionIds);
    }

    @Override
    public void deleteByCategoryIdBatch(List<Integer> categoryIds) {
